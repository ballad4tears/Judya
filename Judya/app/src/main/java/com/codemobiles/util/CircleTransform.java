...
public class CircleTransform extends BitmapTransformation {
    private int BORDER_COLOR = Color.parseColor("#FFA726");
    private int BORDER_RADIUS = 2;

    public CircleTransform(Context context, String hexColor, int width) {
        super(context);
        BORDER_RADIUS = width;
        BORDER_COLOR = Color.parseColor(hexColor);
    }

...
public class Database_Data_sound extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databaseandroiddataallssound";

    // Table Name
    private static final String TABLE_NAME = "databaseandroiddataallstablesound";

	public Database_Data_sound(Context context) {

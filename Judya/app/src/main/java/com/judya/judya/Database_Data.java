...
public class Database_Data extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databaseandroiddataalls";

    // Table Name
    private static final String TABLE_NAME = "databaseandroiddataallstable";

	public Database_Data(Context context) {
